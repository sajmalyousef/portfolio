...
export const about = {
  ...
  throughline: [
    "The thread through all of it is the same: life is hard enough, so I find the thing quietly making it harder, sit with it long enough to truly understand it, and build something that makes people's lives easier and earns something for the business. I care about growth and monetisation as outcomes, not vanity metrics.",
